...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "_dataset/barrier_ds.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "weights/best0724-shuffle.pt", help="model.pt path(s)")
    parser.add_argument("--imgsz", "--img", "--img-size", nargs="+", type=int, default=[672, 672], help="image (h, w)")
