...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="models/yolov5s_ShuffleNetV2.yaml", help="model.yaml path")
    ...
    parser.add_argument("--name", default="v5_shufflenet", help="save to project/name")
